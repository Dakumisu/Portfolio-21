...
var POSTPROCESSING = (() => {
  ...
  // src/materials/DepthDownsamplingMaterial.js
  var DepthDownsamplingMaterial = class extends import_three8.ShaderMaterial {
    constructor() {
      super({
        ...
        uniforms: {
          ...
          normalBuffer: new import_three8.Uniform(null),
          texelSize: new import_three8.Uniform(new import_three8.Vector2())
        },
  ...
  // src/materials/DepthMaskMaterial.js
  var DepthMaskMaterial = class extends import_three9.ShaderMaterial {
    constructor() {
      super({
        ...
        uniforms: {
          inputBuffer: new import_three9.Uniform(null),
          depthBuffer0: new import_three9.Uniform(null),
          depthBuffer1: new import_three9.Uniform(null),
          bias0: new import_three9.Uniform(0),
          bias1: new import_three9.Uniform(0)
        },
      ...
      this.toneMapped = false;
      this.depthMode = import_three9.LessDepth;
      this.setDepthMode(import_three9.LessDepth);
    }
    get keepFar() {
    ...
    setDepthMode(mode) {
      let depthTest;
      switch (mode) {
        case import_three9.NeverDepth:
          depthTest = "false";
          break;
        case import_three9.AlwaysDepth:
          depthTest = "true";
          break;
        case import_three9.EqualDepth:
          depthTest = "abs(d1 - d0) <= EPSILON";
          break;
        case import_three9.NotEqualDepth:
          depthTest = "abs(d1 - d0) > EPSILON";
          break;
        case import_three9.LessDepth:
          depthTest = "d0 > d1";
          break;
        case import_three9.LessEqualDepth:
          depthTest = "d0 >= d1";
          break;
        case import_three9.GreaterEqualDepth:
          depthTest = "d0 <= d1";
          break;
        case import_three9.GreaterDepth:
        default:
          depthTest = "d0 < d1";
          break;
      }
  ...
  var EdgeDetectionMaterial = class extends import_three10.ShaderMaterial {
    constructor(texelSize = new import_three10.Vector2(), mode = EdgeDetectionMode.COLOR) {
      super({
        ...
        uniforms: {
          ...
          predicationBuffer: new import_three10.Uniform(null),
          texelSize: new import_three10.Uniform(texelSize)
        },
        fragmentShader: shader_default5,
        vertexShader: shader_default6,
  ...
  // src/materials/EffectMaterial.js
  var EffectMaterial = class extends import_three11.ShaderMaterial {
    constructor(shaderParts = null, defines = null, uniforms = null, camera, dithering = false) {
      super({
        ...
        uniforms: {
          ...
          resolution: new import_three11.Uniform(new import_three11.Vector2()),
          texelSize: new import_three11.Uniform(new import_three11.Vector2()),
          cameraNear: new import_three11.Uniform(0.3),
          cameraFar: new import_three11.Uniform(1e3),
          aspect: new import_three11.Uniform(1),
          time: new import_three11.Uniform(0)
        },
  ...
  // src/materials/GodRaysMaterial.js
  var GodRaysMaterial = class extends import_three12.ShaderMaterial {
    constructor(lightPosition) {
      super({
        ...
        uniforms: {
          ...
          lightPosition: new import_three12.Uniform(lightPosition),
          density: new import_three12.Uniform(1),
          decay: new import_three12.Uniform(1),
          weight: new import_three12.Uniform(1),
          exposure: new import_three12.Uniform(1),
          clampMax: new import_three12.Uniform(1)
        },
    ...
    constructor(colorOutput = false, luminanceRange = null) {
      ...
      super({
        ...
        uniforms: {
          ...
          range: new import_three13.Uniform(useRange ? luminanceRange : new import_three13.Vector2())
        },
  ...
  // src/materials/MaskMaterial.js
  var MaskMaterial = class extends import_three14.ShaderMaterial {
    constructor(maskTexture = null) {
      super({
        type: "MaskMaterial",
        uniforms: {
          maskTexture: new import_three14.Uniform(maskTexture),
          inputBuffer: new import_three14.Uniform(null),
          strength: new import_three14.Uniform(1)
        },
  ...
  // src/materials/OutlineMaterial.js
  var OutlineMaterial = class extends import_three15.ShaderMaterial {
    constructor(texelSize = new import_three15.Vector2()) {
      super({
  ...
  // src/materials/SMAAWeightsMaterial.js
  var SMAAWeightsMaterial = class extends import_three16.ShaderMaterial {
    constructor(texelSize = new import_three16.Vector2(), resolution = new import_three16.Vector2()) {
      super({
        ...
        uniforms: {
          ...
          areaTexture: new import_three16.Uniform(null),
          searchTexture: new import_three16.Uniform(null),
          texelSize: new import_three16.Uniform(texelSize),
          resolution: new import_three16.Uniform(resolution)
        },
  ...
  // src/materials/SSAOMaterial.js
  var SSAOMaterial = class extends import_three17.ShaderMaterial {
    constructor(camera) {
      super({
        type: "SSAOMaterial",
        defines: {
        ...
        uniforms: {
          normalBuffer: new import_three17.Uniform(null),
          normalDepthBuffer: new import_three17.Uniform(null),
          noiseTexture: new import_three17.Uniform(null),
          inverseProjectionMatrix: new import_three17.Uniform(new import_three17.Matrix4()),
          projectionMatrix: new import_three17.Uniform(new import_three17.Matrix4()),
          texelSize: new import_three17.Uniform(new import_three17.Vector2()),
          cameraNear: new import_three17.Uniform(0),
          cameraFar: new import_three17.Uniform(0),
          distanceCutoff: new import_three17.Uniform(new import_three17.Vector2()),
          proximityCutoff: new import_three17.Uniform(new import_three17.Vector2()),
          noiseScale: new import_three17.Uniform(new import_three17.Vector2()),
          minRadiusScale: new import_three17.Uniform(0.33),
          intensity: new import_three17.Uniform(1),
          fade: new import_three17.Uniform(0.01),
          bias: new import_three17.Uniform(0)
        },
    ...
    adoptCameraSettings(camera = null) {
      if (camera !== null) {
        ...
        if (camera instanceof import_three17.PerspectiveCamera) {
          this.defines.PERSPECTIVE_CAMERA = "1";
        } else {
          delete this.defines.PERSPECTIVE_CAMERA;
        }
  ...
  var dummyCamera = new import_three18.Camera();
  var geometry = null;
  function getFullscreenTriangle() {
    if (geometry === null) {
      const vertices = new Float32Array([-1, -1, 0, 3, -1, 0, -1, 3, 0]);
      const uvs = new Float32Array([0, 0, 2, 0, 0, 2]);
      geometry = new import_three18.BufferGeometry();
      if (geometry.setAttribute !== void 0) {
        geometry.setAttribute("position", new import_three18.BufferAttribute(vertices, 3));
        geometry.setAttribute("uv", new import_three18.BufferAttribute(uvs, 2));
      } else {
        geometry.addAttribute("position", new import_three18.BufferAttribute(vertices, 3));
        geometry.addAttribute("uv", new import_three18.BufferAttribute(uvs, 2));
      }
    }
    return geometry;
  }
  var Pass = class {
    constructor(name = "Pass", scene = new import_three18.Scene(), camera = dummyCamera) {
      this.name = name;
      this.scene = scene;
      this.camera = camera;
      this.screen = null;
    ...
    setFullscreenMaterial(material) {
      ...
      if (screen !== null) {
        ...
        screen = new import_three18.Mesh(getFullscreenTriangle(), material);
        screen.frustumCulled = false;
        if (this.scene === null) {
          this.scene = new import_three18.Scene();
        }
    ...
    dispose() {
      ...
      for (const key of Object.keys(this)) {
        ...
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three18.Scene) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var SavePass = class extends Pass {
    constructor(renderTarget, resize = true) {
      ...
      if (renderTarget === void 0) {
        this.renderTarget = new import_three19.WebGLRenderTarget(1, 1, {
          minFilter: import_three19.LinearFilter,
          magFilter: import_three19.LinearFilter,
          stencilBuffer: false,
          depthBuffer: false
        });
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (!alpha && frameBufferType === import_three19.UnsignedByteType) {
        this.renderTarget.texture.format = import_three19.RGBFormat;
      }
  ...
  var AdaptiveLuminancePass = class extends Pass {
    constructor(luminanceBuffer, {
      ...
      this.needsSwap = false;
      this.renderTargetPrevious = new import_three20.WebGLRenderTarget(1, 1, {
        minFilter: import_three20.NearestFilter,
        magFilter: import_three20.NearestFilter,
        type: import_three20.HalfFloatType,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three20.RGBAFormat
      });
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== import_three20.HalfFloatType) {
  ...
  var Resizer = class {
    constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
      ...
      this.base = new import_three21.Vector2(1, 1);
      this.target = new import_three21.Vector2(width, height);
      this.s = scale;
    }
    get scale() {
      return this.s;
  ...
  var BlurPass = class extends Pass {
    constructor({
      ...
      super("BlurPass");
      this.renderTargetA = new import_three22.WebGLRenderTarget(1, 1, {
        minFilter: import_three22.LinearFilter,
        magFilter: import_three22.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (!alpha && frameBufferType === import_three22.UnsignedByteType) {
        this.renderTargetA.texture.format = import_three22.RGBFormat;
        this.renderTargetB.texture.format = import_three22.RGBFormat;
      }
      if (frameBufferType !== void 0) {
      ...
      this.replaceMaterial = (node) => {
        if (node.isMesh) {
          ...
          switch (node.material.side) {
            case import_three24.DoubleSide:
              materials = this.materialsDoubleSide;
              break;
            case import_three24.BackSide:
    ...
    setMaterial(material) {
      ...
      if (material !== null) {
        ...
        for (const m2 of materials) {
          ...
          m2.side = import_three24.FrontSide;
        }
        materials[2].skinning = true;
        this.materialsBackSide = materials.map((m2) => {
          const c2 = m2.clone();
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three24.BackSide;
          return c2;
        });
        this.materialsDoubleSide = materials.map((m2) => {
          const c2 = m2.clone();
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three24.DoubleSide;
          return c2;
        });
      }
    }
  ...
  var DepthPass = class extends Pass {
    constructor(scene, camera, {
      ...
      super("DepthPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three25.MeshDepthMaterial({
        depthPacking: import_three25.RGBADepthPacking
      }));
      const clearPass = this.renderPass.getClearPass();
      clearPass.overrideClearColor = new import_three25.Color(16777215);
      clearPass.overrideClearAlpha = 1;
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three25.WebGLRenderTarget(1, 1, {
          minFilter: import_three25.NearestFilter,
          magFilter: import_three25.NearestFilter,
          stencilBuffer: false
        });
  ...
  var BlendMode = class extends import_three27.EventDispatcher {
    constructor(blendFunction, opacity = 1) {
      super();
      this.blendFunction = blendFunction;
      this.opacity = new import_three27.Uniform(opacity);
    }
    getBlendFunction() {
  ...
  var Effect = class extends import_three28.EventDispatcher {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three28.Scene) {
            continue;
          }
          this[key].dispose();
        }
    ...
    constructor({
      ...
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three29.WebGLRenderTarget(1, 1, {
          minFilter: import_three29.LinearFilter,
          magFilter: import_three29.LinearFilter,
          format: colorOutput ? import_three29.RGBAFormat : import_three29.LuminanceFormat,
          stencilBuffer: false,
          depthBuffer: false
        });
  ...
  var NormalPass = class extends Pass {
    constructor(scene, camera, {
      ...
      super("NormalPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three30.MeshNormalMaterial());
      const clearPass = this.renderPass.getClearPass();
      clearPass.overrideClearColor = new import_three30.Color(7829503);
      clearPass.overrideClearAlpha = 1;
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three30.WebGLRenderTarget(1, 1, {
          ...
          format: import_three30.RGBFormat,
          stencilBuffer: false
        });
  ...
  var EffectComposer = class {
    ...
    get multisampling() {
      return this.inputBuffer instanceof import_three31.WebGLMultisampleRenderTarget ? this.inputBuffer.samples : 0;
    }
    ...
    replaceRenderer(renderer, updateDOM = true) {
      ...
      if (oldRenderer !== null && oldRenderer !== renderer) {
        const oldSize = oldRenderer.getSize(new import_three31.Vector2());
        const newSize = renderer.getSize(new import_three31.Vector2());
    ...
    createDepthTexture() {
      const depthTexture = this.depthTexture = new import_three31.DepthTexture();
      this.inputBuffer.depthTexture = depthTexture;
      this.inputBuffer.dispose();
      if (this.inputBuffer.stencilBuffer) {
        depthTexture.format = import_three31.DepthStencilFormat;
        depthTexture.type = import_three31.UnsignedInt248Type;
      } else {
        depthTexture.type = import_three31.UnsignedIntType;
      }
      return depthTexture;
    }
    deleteDepthTexture() {
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      const size = this.renderer.getDrawingBufferSize(new import_three31.Vector2());
      const alpha = this.renderer.getContext().getContextAttributes().alpha;
      const options = {
        format: !alpha && type === import_three31.UnsignedByteType ? import_three31.RGBFormat : import_three31.RGBAFormat,
      ...
      const renderTarget = multisampling > 0 ? new import_three31.WebGLMultisampleRenderTarget(size.width, size.height, options) : new import_three31.WebGLRenderTarget(size.width, size.height, options);
      if (multisampling > 0) {
    ...
    addPass(pass, index) {
      ...
      const drawingBufferSize = renderer.getDrawingBufferSize(new import_three31.Vector2());
    ...
    setSize(width, height, updateStyle) {
      ...
      if (width === void 0 || height === void 0) {
        const size = renderer.getSize(new import_three31.Vector2());
        width = size.width;
        height = size.height;
      } else {
  ...
  var BloomEffect = class extends Effect {
    constructor({
      ...
      super("BloomEffect", shader_default44, {
        blendFunction,
        uniforms: new Map([
          ["texture", new import_three32.Uniform(null)],
          ["intensity", new import_three32.Uniform(intensity)]
        ])
      });
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three32.UnsignedByteType) {
        this.renderTarget.texture.format = import_three32.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
      }
  ...
  var BokehEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, focus = 0.5, dof = 0.02, aperture = 0.015, maxBlur = 1} = {}) {
      super("BokehEffect", shader_default45, {
        ...
        uniforms: new Map([
          ["focus", new import_three33.Uniform(focus)],
          ["dof", new import_three33.Uniform(dof)],
          ["aperture", new import_three33.Uniform(aperture)],
          ["maxBlur", new import_three33.Uniform(maxBlur)]
        ])
      });
    }
  };
  ...
  var BrightnessContrastEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, brightness = 0, contrast = 0} = {}) {
      super("BrightnessContrastEffect", shader_default46, {
        blendFunction,
        uniforms: new Map([
          ["brightness", new import_three34.Uniform(brightness)],
          ["contrast", new import_three34.Uniform(contrast)]
        ])
      });
    }
  };
  ...
  var ColorDepthEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, bits = 16} = {}) {
      super("ColorDepthEffect", shader_default48, {
        blendFunction,
        uniforms: new Map([
          ["factor", new import_three35.Uniform(1)]
        ])
      });
      this.bits = 0;
  ...
  var ChromaticAberrationEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, offset = new import_three36.Vector2(1e-3, 5e-4)} = {}) {
      super("ChromaticAberrationEffect", shader_default49, {
        vertexShader: shader_default50,
        blendFunction,
        attributes: EffectAttribute.CONVOLUTION,
        uniforms: new Map([
          ["offset", new import_three36.Uniform(offset)]
        ])
      });
    }
    get offset() {
  ...
  var DepthOfFieldEffect = class extends Effect {
    constructor(camera, {
      ...
      super("DepthOfFieldEffect", shader_default52, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["nearColorBuffer", new import_three37.Uniform(null)],
          ["farColorBuffer", new import_three37.Uniform(null)],
          ["nearCoCBuffer", new import_three37.Uniform(null)],
          ["scale", new import_three37.Uniform(1)]
        ])
      });
      this.camera = camera;
      this.renderTarget = new import_three37.WebGLRenderTarget(1, 1, {
        minFilter: import_three37.LinearFilter,
        magFilter: import_three37.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
      ...
      this.renderTargetCoC.texture.format = import_three37.RGBFormat;
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.blurPass.initialize(renderer, alpha, import_three37.UnsignedByteType);
      if (!alpha && frameBufferType === import_three37.UnsignedByteType) {
        this.renderTargetNear.texture.type = import_three37.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
  ...
  var DotScreenEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, angle = Math.PI * 0.5, scale = 1} = {}) {
      super("DotScreenEffect", shader_default53, {
        blendFunction,
        uniforms: new Map([
          ["angle", new import_three38.Uniform(new import_three38.Vector2())],
          ["scale", new import_three38.Uniform(scale)]
        ])
      });
      this.setAngle(angle);
    }
  ...
  var GammaCorrectionEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, gamma = 2} = {}) {
      super("GammaCorrectionEffect", shader_default54, {
        blendFunction,
        uniforms: new Map([
          ["gamma", new import_three39.Uniform(gamma)]
        ])
      });
    }
  };
  ...
  function getNoise(size, format, type) {
    const channels = new Map([
      [import_three40.LuminanceFormat, 1],
      [import_three40.RedFormat, 1],
      [import_three40.RGFormat, 2],
      [import_three40.RGBFormat, 3],
      [import_three40.RGBAFormat, 4]
    ]);
    let data;
    if (!channels.has(format)) {
      console.error("Invalid noise texture format");
    }
    if (type === import_three40.UnsignedByteType) {
  ...
  var NoiseTexture = class extends import_three40.DataTexture {
    constructor(width, height, format = import_three40.LuminanceFormat, type = import_three40.UnsignedByteType) {
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      delay = new import_three41.Vector2(1.5, 3.5),
      duration = new import_three41.Vector2(0.6, 1),
      strength = new import_three41.Vector2(0.3, 1),
      columns = 0.05,
      ratio = 0.85,
      ...
      super("GlitchEffect", shader_default55, {
        blendFunction,
        uniforms: new Map([
          ["perturbationMap", new import_three41.Uniform(null)],
          ["columns", new import_three41.Uniform(columns)],
          ["active", new import_three41.Uniform(false)],
          ["random", new import_three41.Uniform(1)],
          ["seed", new import_three41.Uniform(new import_three41.Vector2())],
          ["distortion", new import_three41.Uniform(new import_three41.Vector2())]
        ])
      });
      this.setPerturbationMap(perturbationMap === null ? this.generatePerturbationMap(dtSize) : perturbationMap);
      this.delay = delay;
      this.duration = duration;
      this.breakPoint = new import_three41.Vector2(randomFloat(this.delay.x, this.delay.y), randomFloat(this.duration.x, this.duration.y));
      this.time = 0;
    ...
    setPerturbationMap(map) {
      ...
      map.minFilter = map.magFilter = import_three41.NearestFilter;
      map.wrapS = map.wrapT = import_three41.RepeatWrapping;
      map.generateMipmaps = false;
      this.uniforms.get("perturbationMap").value = map;
    }
    generatePerturbationMap(size = 64) {
      const map = new NoiseTexture(size, size, import_three41.RGBFormat);
      map.name = tag;
      return map;
    }
    update(renderer, inputBuffer, deltaTime) {
  ...
  // src/effects/GodRaysEffect.js
  var v = new import_three42.Vector3();
  var m = new import_three42.Matrix4();
  var GodRaysEffect = class extends Effect {
    constructor(camera, lightSource, {
      ...
      super("GodRaysEffect", shader_default56, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["texture", new import_three42.Uniform(null)]
        ])
      });
      this.camera = camera;
      ...
      this.lightScene = new import_three42.Scene();
      this.screenPosition = new import_three42.Vector2();
      this.renderTargetA = new import_three42.WebGLRenderTarget(1, 1, {
      ...
      this.renderTargetLight.depthTexture = new import_three42.DepthTexture();
      this.renderPassLight = new RenderPass(this.lightScene, camera);
      this.renderPassLight.getClearPass().overrideClearColor = new import_three42.Color(0);
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three42.Color(0);
      this.blurPass = new BlurPass({resolutionScale, width, height, kernelSize});
      this.blurPass.resolution.resizable = this;
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three42.UnsignedByteType) {
        this.renderTargetA.texture.format = import_three42.RGBFormat;
        this.renderTargetB.texture.format = import_three42.RGBFormat;
        this.renderTargetLight.texture.format = import_three42.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTargetA.texture.type = frameBufferType;
        this.renderTargetB.texture.type = frameBufferType;
  ...
  var GridEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.OVERLAY, scale = 1, lineWidth = 0} = {}) {
      super("GridEffect", shader_default57, {
        blendFunction,
        uniforms: new Map([
          ["scale", new import_three43.Uniform(new import_three43.Vector2())],
          ["lineWidth", new import_three43.Uniform(lineWidth)]
        ])
      });
      this.resolution = new import_three43.Vector2();
  ...
  var HueSaturationEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, hue = 0, saturation = 0} = {}) {
      super("HueSaturationEffect", shader_default58, {
        blendFunction,
        uniforms: new Map([
          ["hue", new import_three44.Uniform(new import_three44.Vector3())],
          ["saturation", new import_three44.Uniform(saturation)]
        ])
      });
      this.setHue(hue);
    }
  ...
  // src/images/textures/LookupTexture3D.js
  var c = new import_three45.Color();
  var LookupTexture3D = class extends import_three45.DataTexture3D {
    constructor(data, size) {
      super(data, size, size, size);
      this.type = import_three45.FloatType;
      this.format = import_three45.RGBFormat;
      this.encoding = import_three45.LinearEncoding;
      this.minFilter = import_three45.LinearFilter;
      this.magFilter = import_three45.LinearFilter;
      this.wrapS = import_three45.ClampToEdgeWrapping;
      this.wrapT = import_three45.ClampToEdgeWrapping;
      this.wrapR = import_three45.ClampToEdgeWrapping;
      this.unpackAlignment = 1;
      this.domainMin = new import_three45.Vector3(0, 0, 0);
      this.domainMax = new import_three45.Vector3(1, 1, 1);
    }
    ...
    applyLUT(lut) {
      ...
      } else if (lut.type !== import_three45.FloatType || this.type !== import_three45.FloatType) {
        console.error("Both LUTs must be FloatType textures");
      } else if (lut.format !== import_three45.RGBFormat || this.format !== import_three45.RGBFormat) {
    ...
    convertToUint8() {
      if (this.type === import_three45.FloatType) {
        ...
        this.type = import_three45.UnsignedByteType;
        this.needsUpdate = true;
      }
      return this;
    }
    convertToFloat() {
      if (this.type === import_three45.UnsignedByteType) {
    ...
    convertLinearToSRGB() {
      ...
      if (this.type === import_three45.FloatType) {
        const stride = this.format === import_three45.RGBAFormat ? 4 : 3;
        for (let i = 0, l = data.length; i < l; i += stride) {
          c.fromArray(data, i).convertLinearToSRGB().toArray(data, i);
        }
        this.encoding = import_three45.sRGBEncoding;
        this.needsUpdate = true;
      } else {
    ...
    convertToRGBA() {
      if (this.format === import_three45.RGBFormat) {
        ...
        this.format = import_three45.RGBAFormat;
        this.needsUpdate = true;
      }
      return this;
    }
    toDataTexture() {
      ...
      const texture = new import_three45.DataTexture(this.image.data, width, height);
      texture.name = this.name;
      texture.type = this.type;
      texture.format = this.format;
      texture.encoding = this.encoding;
      texture.minFilter = import_three45.LinearFilter;
      texture.magFilter = import_three45.LinearFilter;
  ...
  var LUTEffect = class extends Effect {
    constructor(lut, {
      ...
      super("LUTEffect", shader_default59, {
        blendFunction,
        uniforms: new Map([
          ["lut", new import_three46.Uniform(null)],
          ["scale", new import_three46.Uniform(new import_three46.Vector3())],
          ["offset", new import_three46.Uniform(new import_three46.Vector3())],
          ["domainMin", new import_three46.Uniform(null)],
          ["domainMax", new import_three46.Uniform(null)]
        ])
      });
      this.tetrahedralInterpolation = tetrahedralInterpolation;
      this.inputEncoding = import_three46.sRGBEncoding;
      this.outputEncoding = this.inputEncoding;
      this.setInputEncoding(import_three46.sRGBEncoding);
      this.setLUT(lut);
    }
    getOutputEncoding() {
    ...
    setInputEncoding(value) {
      ...
      switch (value) {
        case import_three46.sRGBEncoding:
          defines.set("linearToInputTexel(texel)", "LinearTosRGB(texel)");
          break;
        case import_three46.LinearEncoding:
      ...
      if (lut !== null) {
        this.outputEncoding = lut.encoding === import_three46.LinearEncoding ? value : lut.encoding;
    ...
    setLUT(lut) {
      ...
      if (this.getLUT() !== lut) {
        ...
        if (lut.type === import_three46.FloatType || lut.type === import_three46.HalfFloatType) {
          defines.set("LUT_PRECISION_HIGH", "1");
        }
        if (image.width > image.height) {
          defines.set("LUT_STRIP_HORIZONTAL", "1");
        } else if (lut instanceof import_three46.DataTexture3D) {
    ...
    configureTetrahedralInterpolation() {
      const lut = this.getLUT();
      lut.minFilter = import_three46.LinearFilter;
      lut.magFilter = import_three46.LinearFilter;
      this.defines.delete("TETRAHEDRAL_INTERPOLATION");
      if (this.tetrahedralInterpolation && lut !== null) {
        if (lut instanceof import_three46.DataTexture3D) {
          this.defines.set("TETRAHEDRAL_INTERPOLATION", "1");
          lut.minFilter = import_three46.NearestFilter;
          lut.magFilter = import_three46.NearestFilter;
        } else {
  ...
  var OutlineEffect = class extends Effect {
    constructor(scene, camera, {
      ...
      super("OutlineEffect", shader_default61, {
        uniforms: new Map([
          ["maskTexture", new import_three47.Uniform(null)],
          ["edgeTexture", new import_three47.Uniform(null)],
          ["edgeStrength", new import_three47.Uniform(edgeStrength)],
          ["visibleEdgeColor", new import_three47.Uniform(new import_three47.Color(visibleEdgeColor))],
          ["hiddenEdgeColor", new import_three47.Uniform(new import_three47.Color(hiddenEdgeColor))],
          ["pulse", new import_three47.Uniform(1)],
          ["patternScale", new import_three47.Uniform(1)],
          ["patternTexture", new import_three47.Uniform(null)]
        ])
      });
      ...
      this.scene = scene;
      this.camera = camera;
      this.renderTargetMask = new import_three47.WebGLRenderTarget(1, 1, {
        minFilter: import_three47.LinearFilter,
        magFilter: import_three47.LinearFilter,
        stencilBuffer: false,
        format: import_three47.RGBFormat
      });
      ...
      this.clearPass = new ClearPass();
      this.clearPass.overrideClearColor = new import_three47.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      this.depthPass = new DepthPass(scene, camera);
      this.maskPass = new RenderPass(scene, camera, new DepthComparisonMaterial(this.depthPass.texture, camera));
      const clearPass = this.maskPass.getClearPass();
      clearPass.overrideClearColor = new import_three47.Color(16777215);
      clearPass.overrideClearAlpha = 1;
      this.blurPass = new BlurPass({resolutionScale, width, height, kernelSize});
      this.blurPass.resolution.resizable = this;
      this.blur = blur;
    ...
    setPatternTexture(texture) {
      if (texture !== null) {
        texture.wrapS = texture.wrapT = import_three47.RepeatWrapping;
    ...
    initialize(renderer, alpha, frameBufferType) {
      this.blurPass.initialize(renderer, alpha, import_three47.UnsignedByteType);
      if (frameBufferType !== void 0) {
    ...
    constructor(granularity = 30) {
      super("PixelationEffect", shader_default63, {
        uniforms: new Map([
          ...
          ["d", new import_three48.Uniform(new import_three48.Vector2())]
        ])
      });
  ...
  var RealisticBokehEffect = class extends Effect {
    constructor({
      ...
      super("RealisticBokehEffect", shader_default64, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: new Map([
          ["focus", new import_three49.Uniform(focus)],
          ["focalLength", new import_three49.Uniform(focalLength)],
          ["fStop", new import_three49.Uniform(fStop)],
          ["luminanceThreshold", new import_three49.Uniform(luminanceThreshold)],
          ["luminanceGain", new import_three49.Uniform(luminanceGain)],
          ["bias", new import_three49.Uniform(bias)],
          ["fringe", new import_three49.Uniform(fringe)],
          ["maxBlur", new import_three49.Uniform(maxBlur)],
          ["dof", new import_three49.Uniform(null)]
        ])
      });
      this.rings = rings;
      this.samples = samples;
    ...
    set manualDoF(value) {
      if (this.manualDoF !== value) {
        if (value) {
          ...
          this.uniforms.get("dof").value = new import_three49.Vector4(0.2, 1, 0.2, 2);
        } else {
  ...
  var ScanlineEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.OVERLAY, density = 1.25} = {}) {
      super("ScanlineEffect", shader_default65, {
        blendFunction,
        uniforms: new Map([
          ["count", new import_three50.Uniform(0)]
        ])
      });
  ...
  var v2 = new import_three51.Vector3();
  var ab = new import_three51.Vector3();
  var ShockWaveEffect = class extends Effect {
    constructor(camera, epicenter = new import_three51.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
      ...
      super("ShockWaveEffect", shader_default66, {
        ...
        uniforms: new Map([
          ["active", new import_three51.Uniform(false)],
          ["center", new import_three51.Uniform(new import_three51.Vector2(0.5, 0.5))],
          ["cameraDistance", new import_three51.Uniform(1)],
          ["size", new import_three51.Uniform(1)],
          ["radius", new import_three51.Uniform(-waveSize)],
          ["maxRadius", new import_three51.Uniform(maxRadius)],
          ["waveSize", new import_three51.Uniform(waveSize)],
          ["amplitude", new import_three51.Uniform(amplitude)]
        ])
      });
      this.camera = camera;
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    constructor(scene, camera, options) {
      ...
      depthMaskMaterial.defines.DEPTH_PACKING_1 = import_three52.RGBADepthPacking.toFixed(0);
      depthMaskMaterial.setDepthMode(import_three52.EqualDepth);
      this.renderTargetMasked = new import_three52.WebGLRenderTarget(1, 1, {
        minFilter: import_three52.LinearFilter,
        magFilter: import_three52.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
    ...
    get inverted() {
      return this.depthMaskMaterial.getDepthMode() === import_three52.NotEqualDepth;
    }
    set inverted(value) {
      this.depthMaskMaterial.setDepthMode(value ? import_three52.NotEqualDepth : import_three52.EqualDepth);
    }
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.depthPass.initialize(renderer, alpha, frameBufferType);
      this.depthMaskPass.initialize(renderer, alpha, frameBufferType);
      if (!alpha && frameBufferType === import_three52.UnsignedByteType) {
        this.renderTargetMasked.texture.format = import_three52.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTargetMasked.texture.type = frameBufferType;
      }
  ...
  var SepiaEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, intensity = 1} = {}) {
      super("SepiaEffect", shader_default68, {
        blendFunction,
        uniforms: new Map([
          ["intensity", new import_three53.Uniform(intensity)]
        ])
      });
    }
  };
  ...
  var SMAAEffect = class extends Effect {
    constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
      ...
      this.renderTargetEdges = new import_three54.WebGLRenderTarget(1, 1, {
        minFilter: import_three54.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three54.RGBFormat
      });
      this.renderTargetEdges.texture.name = "SMAA.Edges";
      this.renderTargetWeights = this.renderTargetEdges.clone();
      this.renderTargetWeights.texture.name = "SMAA.Weights";
      this.renderTargetWeights.texture.format = import_three54.RGBAFormat;
      this.uniforms.get("weightMap").value = this.renderTargetWeights.texture;
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three54.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      this.edgeDetectionPass = new ShaderPass(new EdgeDetectionMaterial(new import_three54.Vector2(), edgeDetectionMode));
      ...
      searchTexture.format = import_three54.RGBAFormat;
      ...
      areaTexture.format = import_three54.RGBAFormat;
  ...
  var SSAOEffect = class extends Effect {
    constructor(camera, normalBuffer, {
      ...
      super("SSAOEffect", shader_default71, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["aoBuffer", new import_three55.Uniform(null)],
          ["normalDepthBuffer", new import_three55.Uniform(null)],
          ["luminanceInfluence", new import_three55.Uniform(luminanceInfluence)],
          ["color", new import_three55.Uniform(null)],
          ["scale", new import_three55.Uniform(0)]
        ])
      });
      this.renderTargetAO = new import_three55.WebGLRenderTarget(1, 1, {
        minFilter: import_three55.LinearFilter,
        magFilter: import_three55.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three55.RGBFormat
      });
      ...
      this.ssaoPass = new ShaderPass((() => {
        ...
        noiseTexture.wrapS = noiseTexture.wrapT = import_three55.RepeatWrapping;
    ...
    set color(value) {
      ...
      if (value !== null) {
        if (defines.has("COLORIZE")) {
          ...
          uniforms.get("color").value = new import_three55.Color(value);
          this.setChanged();
        }
  ...
  var TextureEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, texture = null, aspectCorrection = false} = {}) {
      super("TextureEffect", shader_default72, {
        ...
        uniforms: new Map([
          ["texture", new import_three56.Uniform(null)],
          ["scale", new import_three56.Uniform(1)],
          ["uvTransform", new import_three56.Uniform(null)]
        ])
      });
      ...
      if (currentTexture !== value) {
        ...
        if (value !== null) {
          switch (value.encoding) {
            case import_three56.sRGBEncoding:
              this.defines.set("texelToLinear(texel)", "sRGBToLinear(texel)");
              break;
            case import_three56.LinearEncoding:
    ...
    set uvTransform(value) {
      if (this.uvTransform !== value) {
        if (value) {
          ...
          this.uniforms.get("uvTransform").value = new import_three56.Matrix3();
          this.setVertexShader(shader_default73);
        } else {
  ...
  var ToneMappingEffect = class extends Effect {
    constructor({
      ...
      super("ToneMappingEffect", shader_default74, {
        blendFunction,
        uniforms: new Map([
          ["luminanceBuffer", new import_three57.Uniform(null)],
          ["maxLuminance", new import_three57.Uniform(maxLuminance)],
          ["whitePoint", new import_three57.Uniform(whitePoint)],
          ["middleGrey", new import_three57.Uniform(middleGrey)],
          ["averageLuminance", new import_three57.Uniform(averageLuminance)]
        ])
      });
      this.renderTargetLuminance = new import_three57.WebGLRenderTarget(1, 1, {
        minFilter: import_three57.LinearMipmapLinearFilter !== void 0 ? import_three57.LinearMipmapLinearFilter : import_three57.LinearMipMapLinearFilter,
        magFilter: import_three57.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three57.RGBFormat
      });
  ...
  var VignetteEffect = class extends Effect {
    constructor(options = {}) {
      ...
      super("VignetteEffect", shader_default75, {
        ...
        uniforms: new Map([
          ["offset", new import_three58.Uniform(settings.offset)],
          ["darkness", new import_three58.Uniform(settings.darkness)]
        ])
      });
    ...
    generate() {
      ...
      return promise.then((urls) => {
        return new Promise((resolve, reject) => {
          ...
          const manager = new import_three59.LoadingManager();
  ...
  var LUT3dlLoader = class extends import_three60.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = null) {
      const externalManager = this.manager;
      const internalManager = new import_three60.LoadingManager();
      const loader = new import_three60.FileLoader(internalManager);
    ...
    parse(input) {
      ...
      lut.encoding = import_three60.sRGBEncoding;
      return lut;
    }
  };
  ...
  var LUTCubeLoader = class extends import_three61.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = null) {
      const externalManager = this.manager;
      const internalManager = new import_three61.LoadingManager();
      const loader = new import_three61.FileLoader(internalManager);
      loader.setPath(this.path);
      loader.setResponseType("text");
      return new Promise((resolve, reject) => {
        internalManager.onError = (url2) => {
    ...
    parse(input) {
      ...
      const data = new Float32Array(size ** 3 * 3);
      const domainMin = new import_three61.Vector3(0, 0, 0);
      const domainMax = new import_three61.Vector3(1, 1, 1);
      ...
      const lut = new LookupTexture3D(data, size, size, size);
      lut.encoding = import_three61.sRGBEncoding;
  ...
  var SMAAImageLoader = class extends import_three62.Loader {
    load(onLoad = () => {
    }, onError = null) {
      ...
      const externalManager = this.manager;
      const internalManager = new import_three62.LoadingManager();
      return new Promise((resolve, reject) => {
        const searchImage = new Image();
        const areaImage = new Image();
        internalManager.onError = (url) => {
