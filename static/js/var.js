...
const VarConst = {
    ...
    soundActivation: document.querySelector('.soundActivation'),
    ...
    textContactContainer: document.querySelectorAll('.contact--container .content a'),
    textAboutContainer: document.querySelector('.about--content .text--container'),
...
let VarLet = {
    ...
    isFirstTextToggle: false,
    isSecondTextToggle: false,
    isThirdTextToggle: false,
    isFourthTextToggle: false,
    ...
    planeY: 0,
    icebergLeftPos: 0,
    initialIcebergScaleValue: .28,
    currentIcebergScaleValue: 0,
